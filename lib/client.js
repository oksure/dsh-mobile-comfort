window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = [
			...
			"    min-height: 44px !important;",
			"  }",
			"  [data-details-collapsed]:not([data-sidebar-collapsed=\"true\"]) > :first-child [class*=\"_sessionRow\"][role=\"treeitem\"][aria-selected] {",
			"    height: 32px !important;",
			"    min-height: 32px !important;",
			"    margin-block: 0 !important;",
			"    position: relative !important;",
			"  }",
			"  [data-details-collapsed]:not([data-sidebar-collapsed=\"true\"]) > :first-child [class*=\"_sessionRow\"][role=\"treeitem\"][aria-selected]::before {",
			"    content: \"\";",
			"    position: absolute;",
			"    inset: -6px 0;",
			"    z-index: 0;",
		...
		function apply(ctx) {
			ctx.effect(() => {
				...
				const openMobileSession = (row) => {
					const frame = row.closest("[data-details-collapsed]");
